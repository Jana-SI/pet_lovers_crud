    ...
    axios.post('/cadastro_cliente', {
        cpf: cpf
            ...
            if (response.data.cpfValido == "false") {
                ...
                var CadCliente = document.getElementById("CadCliente");
                CadCliente.classList.remove("alert-success");
                CadCliente.classList.add("alert-danger");
                

            } else {
                cpfFormElement.setCustomValidity("")
                var CadCliente = document.getElementById("CadCliente");
                CadCliente.classList.remove("alert-danger");
                CadCliente.classList.add("alert-success");
            }
        }, (error) => {
            console.log(error)
        })
